const initialState = {
  ...
  relatedProducts: [
    ...
    },
    {
      ...
      slogan: "You've got to wear EXAMPLE",
      description:
        "Where you're going you might not need roads, but you definitely need some shades. Give those baby blues a rest and let the future shine bright on these timeless lenses.",
      category: 'Accessories',
      default_price: '69.00',
  ...
  reviews: [
    {
      ...
      recommend: true,
      response: '',
      body: 'I really did or did not like this product based on whether it was sustainably sourced. Then I found out that its made from nothing at all.  I really did or did not like this product based on whether it was sustainably sourced. Then I found out that its made from nothing at all.',
  ...
  questions: [
    ...
    {
      question_id: 542846,
      question_body: 'Is this waterproof?',
      question_date: '2021-10-30T00:00:00.000Z',
      asker_name: 'Clayton',
